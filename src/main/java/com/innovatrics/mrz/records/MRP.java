...
public class MRP extends MrzRecord {
    ...
    /**
     * true if the personal number check digit is valid
     */
    ...
    public void fromMrz(String mrz) {
        ...
        validComposite =
                parser.checkDigit(
                        ...
                        parser.rawValue(
                                new MrzRange(0, 10, 1),
                                new MrzRange(13, 20, 1),
                                new MrzRange(21, 43, 1)),
                        "mrz");
    }
    ...
    public String toMrz() {
        ...
        final String dob =
                dateOfBirth.toMrz() + MrzParser.computeCheckDigitChar(dateOfBirth.toMrz());
        sb.append(dob);
        sb.append(sex.mrz);
        final String edpn =
                expirationDate.toMrz()
                        + MrzParser.computeCheckDigitChar(expirationDate.toMrz())
                        + MrzParser.toMrz(personalNumber, 14)
